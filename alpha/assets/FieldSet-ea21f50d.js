import{j as l}from"./jsx-runtime-f6d73c06.js";import{r as T}from"./index-8ee6c85d.js";import{s as S}from"./styled-components.browser.esm-f5d1b584.js";import{z as g,A as x,B as F,E as p,F as O,G as k,H as E,T as h,I as j,J as v,K as z,M as f,k as C}from"./index-916df0c6.js";import{S as _}from"./index-c95a45d0.js";const R=t=>{const e=t!=null&&t.algorithm?g(t.algorithm):g(p),r=Object.assign(Object.assign({},x),t==null?void 0:t.token);return F(r,{override:t==null?void 0:t.token},e,O)},q=R;function A(t){const{sizeUnit:e,sizeStep:r}=t,n=r-2;return{sizeXXL:e*(n+10),sizeXL:e*(n+6),sizeLG:e*(n+2),sizeMD:e*(n+2),sizeMS:e*(n+1),size:e*n,sizeSM:e*n,sizeXS:e*(n-1),sizeXXS:e*(n-1)}}const M=(t,e)=>{const r=e??p(t),n=r.fontSizeSM,o=r.controlHeight-4;return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({},r),A(e??t)),k(n)),{controlHeight:o}),E(Object.assign(Object.assign({},r),{controlHeight:o})))},V=M,s=(t,e)=>new h(t).setAlpha(e).toRgbString(),d=(t,e)=>new h(t).lighten(e).toHexString(),$=t=>{const e=j(t,{theme:"dark"});return{1:e[0],2:e[1],3:e[2],4:e[3],5:e[6],6:e[5],7:e[4],8:e[6],9:e[5],10:e[4]}},I=(t,e)=>{const r=t||"#000",n=e||"#fff";return{colorBgBase:r,colorTextBase:n,colorText:s(n,.85),colorTextSecondary:s(n,.65),colorTextTertiary:s(n,.45),colorTextQuaternary:s(n,.25),colorFill:s(n,.18),colorFillSecondary:s(n,.12),colorFillTertiary:s(n,.08),colorFillQuaternary:s(n,.04),colorBgElevated:d(r,12),colorBgContainer:d(r,8),colorBgLayout:d(r,0),colorBgSpotlight:d(r,26),colorBgBlur:s(n,.04),colorBorder:d(r,26),colorBorderSecondary:d(r,19)}},B=(t,e)=>{const r=Object.keys(v).map(o=>{const a=j(t[o],{theme:"dark"});return new Array(10).fill(1).reduce((i,U,c)=>(i[`${o}-${c+1}`]=a[c],i[`${o}${c+1}`]=a[c],i),{})}).reduce((o,a)=>(o=Object.assign(Object.assign({},o),a),o),{}),n=e??p(t);return Object.assign(Object.assign(Object.assign({},n),r),z(t,{generateColorPalettes:$,generateNeutralColorPalettes:I}))},L=B;function N(){const[t,e,r]=C();return{theme:t,token:e,hashId:r}}const H={defaultConfig:f,defaultSeed:f.token,useToken:N,defaultAlgorithm:p,darkAlgorithm:L,compactAlgorithm:V,getDesignToken:q},u=S.fieldset`
  padding: 0.5rem;
  border-color: #d9d9d9;
  border-width: 1px;
  border-style: solid;
