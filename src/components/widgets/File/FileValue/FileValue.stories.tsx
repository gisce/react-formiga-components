...
export default {
  ...
  argTypes: {
    ...
    filename: {
      description: "Complete filename with extension",
      table: { category },
    },
    onChange: {
      table: {
    ...
    value: {
      description: "File value in base 64",
      table: {
        category,
      },
    },
  },
} as ComponentMeta<typeof FileValue>;

const Template: ComponentStory<typeof FileValue> = (args) => (
  <FileValue {...args} />
);
