...
export type TranslatableDataMethods = {
    ...
    onGetValuesForLangs: (opts: OnGetValuesForLangsOpts) => Promise<ValuesForLangs>;
    onSucceed?: () => void;
};
export type TranslatableModalProps = LocaleType & TranslatableDataMethods & {
    onClose: () => void;
    visible: boolean;
    name: string;
    id?: number;
...
//# sourceMappingURL=TranslatableModal.types.d.ts.map